  ...
  function(e, t, n) {
    ...
    function r(e, t) {
      ...
      for (
        t &&
        null != t.children &&
        (k.length || k.push(t.children), delete t.children);
        k.length;

      )
        if ((r = k.pop()) && void 0 !== r.pop)
          for (i = r.length; i--; ) k.push(r[i])
        else
      ...
      if (("className" === t && (t = "class"), "key" === t));
        ...
        if ("style" === t) {
          if (
            ...
            for (var i in r)
              e.style[i] =
                "number" == typeof r[i] && !1 === U.test(i) ? r[i] + "px" : r[i]
          }
    ...
    function N(e, t, n, r, o, i) {
      Q++ ||
        ((Y = null != o && void 0 !== o.ownerSVGElement),
    ...
    function g(e, t, n, r, o) {
      ...
      return (
        ...
        null == u.nextSibling
          ...
          : ((p && p.length) || null != u) &&
            D(i, p, n, r, P || null != M.dangerouslySetInnerHTML),
        T(i, t.attributes, M),
        (Y = a),
        i
      )
    ...
    function D(e, t, n, r, o) {
      ...
      if (0 !== D)
        for (var z = 0; D > z; z++) {
          ...
          null != w
            ? (d++, (y[w] = b))
            : (v || (void 0 !== b.splitText ? !o || b.nodeValue.trim() : o)) &&
              (f[j++] = b)
        }
      if (0 !== T)
        for (var z = 0; T > z; z++) {
          ...
          var w = c.key
          if (null != w)
            d && void 0 !== y[w] && ((M = y[w]), (y[w] = void 0), d--)
          else if (j > N)
            for (i = N; j > i; i++)
      ...
      if (!e._disable) {
        ...
        if (
          (e.constructor.getDerivedStateFromProps &&
            ((c = o(o({}, c), e.constructor.getDerivedStateFromProps(u, c))),
            (e.state = c)),
          g &&
            ((e.props = p),
            (e.state = f),
          ...
          ;(i = e.render(u, c, l)),
            ...
            g &&
              ...
              (m = e.getSnapshotBeforeUpdate(p, f))
          var O,
            I,
            E = i && i.nodeName
          if ("function" == typeof E) {
            ...
            (s = j),
              ...
              (j || 1 === t) &&
                (s && (s._component = null),
                (I = N(s, i, l, n || !g, j && j.parentNode, !0)))
          if (j && I !== j && a !== T) {
            var A = j.parentNode
            A &&
              I !== A &&
              (A.replaceChild(I, j), O || ((j._component = null), h(j, !1)))
          }
        ...
        for (
          !g || n
            ? _.unshift(e)
            : b ||
              (e.componentDidUpdate && e.componentDidUpdate(p, f, m),
    ...
    ;(function(e) {
      ...
      function M(e) {
        if (Vn.spyListeners.length)
          for (var t = Vn.spyListeners, n = 0, r = t.length; r > n; n++) t[n](e)
      }
      function l(e) {
      ...
      function d(e) {
        me(!0 !== e[sn], "Illegal state: cannot recycle array as iterator"),
          Ce(e, sn, !0)
        var t = -1
        return (
          Ce(e, "next", function() {
      ...
      function w(e) {
        E(e.prevAllowStateChanges),
          Mt(),
          mt(e.prevDerivation),
          e.notifySpy && p({ time: Date.now() - e.startTime })
      }
      function m(e) {
        me(null === Vn.trackingDerivation, T("m028")),
          (Vn.strictMode = e),
      ...
      function L(e, t, n, r, o) {
        function i(i, a, s, u, c) {
          if (
            ...
            return (
              ...
              }),
              {
                ...
                get: function() {
                  return (
                    !0 !== this.__mobxDidRunLazyInitializers && A(this),
                    t.call(this, a)
                  )
                },
                set: function(e) {
          ...
          return (
            (3 > arguments.length || (5 === arguments.length && 3 > c)) &&
      ...
      function P(e, t, n, r) {
        ...
        return (
          ("function" === o ||
            "object" === o ||
            "object" == (void 0 === t ? "undefined" : en(t))) &&
          B(e, t, n, r)
        )
      }
      function B(e, t, n, r) {
        ...
        if (!i) {
          if (
            "object" != (void 0 === e ? "undefined" : en(e)) ||
            "object" != (void 0 === t ? "undefined" : en(t))
          )
            return !1
          var a = e.constructor,
        ...
        if ((n.push(e), r.push(t), i)) {
          ...
          for (; u--; )
            if (((c = M[u]), !G(t, c) || !P(e[c], t[c], n, r))) return !1
        }
      ...
      function q(e, t) {
        ...
        me(Object.isExtensible(e), T("m035")),
          ke(e) ||
            (t = (e.constructor.name || "ObservableObject") + "@" + ve()),
      ...
      function X(e, t, n, r) {
        ...
        if ("value" in n)
          if (ye(n.value)) {
            ...
            _(n.value) && !0 === n.value.autoBind
              ? Q(e.target, t, n.value.originalFn)
              : wn(n.value)
              ? te(e, t, n.value)
              : K(e, t, n.value, r)
      ...
      function ue(e) {
        return (
          ...
          L(
            function(t, n, r, o, i) {
              Qe(t, n), me(!i || !i.get, T("m022")), K(q(t, void 0), n, r, e)
            },
            function(e) {
      ...
      function le(e, t, n) {
        me(arguments.length >= 2, T("m014")),
          ...
          n.forEach(function(e) {
            me("object" === (void 0 === e ? "undefined" : en(e)), T("m017")),
              me(!se(e), T("m018"))
          })
      ...
      function pe(e) {
        ...
        if (
          (me(1 >= arguments.length, T("m021")), me(!ye(e), T("m020")), se(e))
        )
          return e
      ...
      function de(e, t) {
        return (
          me(!ye(t), "Modifiers cannot be nested"),
      ...
      function xe(e) {
        return (
          -1 === Bn.indexOf(e) &&
          (Bn.push(e), console.error("[mobx] Deprecated: " + e), !0)
        )
      }
      function Oe(e) {
        var t = !1
        ...
        return (
          ...
          void 0 !== t
            ...
            : (A(e),
              e.$mobx
                ? e.$mobx
                : void me(!1, "Cannot obtain administration from " + e))
        )
      }
      function Ke(e, t) {
        var n
        return (
          (n = void 0 !== t ? qe(e, t) : ae(e) || Yn(e) ? Xe(e) : qe(e)), n.name
        )
      }
      function et(e, t) {
        return tt(qe(e, t))
      ...
      function tt(e) {
        ...
        return (
          e.observing &&
            ...
            (t.dependencies = Ie(e.observing).map(tt)),
          t
        )
      }
      function nt(e, t) {
      ...
      function ut(e) {
        e.isPendingUnobservation ||
          ((e.isPendingUnobservation = !0), Vn.pendingUnobservations.push(e))
      }
      function ct() {
        Vn.inBatch++
      }
        ...
        if (e.lowestObserverState !== qn.STALE) {
          ...
          for (var t = e.observers, n = t.length; n--; ) {
            ...
            r.dependenciesState === qn.UP_TO_DATE &&
              (r.isTracing !== Xn.NONE && dt(r, e), r.onBecomeStale()),
        ...
        if (e.lowestObserverState !== qn.STALE) {
          ...
          for (var t = e.observers, n = t.length; n--; ) {
            ...
            r.dependenciesState === qn.POSSIBLY_STALE
              ? (r.dependenciesState = qn.STALE)
              : r.dependenciesState === qn.UP_TO_DATE &&
                (e.lowestObserverState = qn.UP_TO_DATE)
          }
        }
      }
      function yt(e) {
      ...
      function Dt(e) {
        switch (e.dependenciesState) {
          ...
          case qn.POSSIBLY_STALE:
            for (
              var t = wt(), n = e.observing, r = n.length, o = 0;
              r > o;
              o++
            ) {
              var i = n[o]
      ...
      function jt(e) {
        ...
        Vn.computationDepth > 0 && t && we(T("m031") + e.name),
          !Vn.allowStateChanges &&
            t &&
            we(T(Vn.strictMode ? "m030a" : "m030b") + e.name)
      }
      function Tt(e, t, n) {
        xt(e),
      ...
      function _t(e) {
        return (
          xe("asReference is deprecated, use observable.ref instead"), Cn.ref(e)
        )
      }
      function Qt(e) {
        return (
      ...
      function Yt(e) {
        return (
          xe("asFlat is deprecated, use observable.shallow instead"),
          Cn.shallow(e)
        )
      }
      function Pt(e) {
      ...
      function Bt(e) {
        return L(
          function(t, n, r, o, i) {
            me(void 0 !== i, T("m009")),
              me("function" == typeof i.get, T("m010")),
              ee(q(t, ""), n, i.get, i.set, e, !1)
          },
          function(e) {
            var t = this.$mobx.values[e]
            if (void 0 !== t) return t.get()
      ...
      function Kt(e, t, n) {
        ...
        if (Yn(e) || j(e) || gn(e)) r = Xe(e)
          ...
          if (!ae(e))
            return we("Expected observable map, object or array as first array")
          if ("string" != typeof t)
            return we(
          ...
          return (
            ...
            (t.prototype.set = function(e) {
              ...
              if ((e = this.prepareNewValue(e)) !== dn) {
                var n = c()
                n &&
                  l({ type: "update", object: this, newValue: e, oldValue: t }),
                  this.setNewValue(e),
                  n && p()
              }
            }),
        ...
        vn = (function() {
          ...
          return (
            ...
            (e.prototype.trackAndCompute = function() {
              c() &&
                M({ object: this.scope, type: "compute", fn: this.derivation })
              var e = this.value,
      ...
      var wn = Ye("ComputedValue", vn),
        ...
        Un = {
          ...
          map: function(e, t) {
            return arguments.length > 2 && fe("map"), new Qn(e, Ne, t)
          },
          shallowMap: function(e, t) {
            return arguments.length > 2 && fe("shallowMap"), new Qn(e, De, t)
          },
          object: function(e, t) {
        ...
        Qn = (function() {
          ...
          return (
            ...
            (e.prototype.get = function(e) {
              return (
                (e = "" + e),
                this.dehanceValue(this.has(e) ? this._data[e].get() : void 0)
              )
            }),
            (e.prototype.dehanceValue = function(e) {
              return void 0 !== this.dehancer ? this.dehancer(e) : e
              ...
              return (
                ...
                Te(function() {
                  ke(e)
                    ...
                    : null !== e &&
                      void 0 !== e &&
                      we("Cannot initialize map from " + e)
                }),
                this
              )
            }),
      ...
      N(Qn.prototype, function() {
        return this.entries()
      })
      var Yn = Ye("ObservableMap", Qn),
        Pn = []
      Object.freeze(Pn)
      var Bn = [],
        Rn = function() {},
      ...
      var Kn = (function() {
        ...
        er = (function() {
          ...
          return (
            ...
            (e.prototype.schedule = function() {
              this._isScheduled ||
                ((this._isScheduled = !0), Vn.pendingReactions.push(this), St())
            }),
              ...
              this.isDisposed ||
                ...
                Dt(this) &&
                  ...
                  this._isTrackPending &&
                    c() &&
                    M({ object: this, type: "scheduled-reaction" })),
                Mt())
            }),
            (e.prototype.track = function(e) {
              ...
              n &&
                ((t = Date.now()),
                l({ object: this, type: "reaction", fn: e })),
                (this._isRunning = !0)
        ...
        ar = function(e, t) {
          ...
          me("function" == typeof e, T("m011")),
            me(3 > arguments.length, T("m012"))
            ...
            get: function() {
              return (
                cr ||
                  ((cr = !0),
                  console.warn(
                    "Using default export (`import mobx from 'mobx'`) is deprecated and wonâ€™t work in mobx@4.0.0\nUse `import * as mobx from 'mobx'` instead"
                  )),
                t
              )
            },
      ...
      "object" ===
        ("undefined" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__
          ? "undefined"
          : en(__MOBX_DEVTOOLS_GLOBAL_HOOK__)) &&
  ...
  function(e, t, n) {
    ...
    function f(e) {
      M(e, "componentWillMount", !0),
        ...
        e.shouldComponentUpdate ||
          (e.shouldComponentUpdate = z.shouldComponentUpdate)
    }
    var y =
      "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
                ...
                return (
                  (a = new g.Reaction(n + ".render()", function() {
                    if (
                      ...
                      try {
                        ;(o = !0),
                          r || D.Component.prototype.forceUpdate.call(t),
                          (e = !1)
                      } finally {
                        ;(o = !1), e && a.dispose()
                      }
          ...
          },
          {
            ...
            value: function(e) {
              ...
              return (
                ...
                fetch(this.apiURL + e, a({}, n, { headers: r })).then(function(
                  e
                ) {
  ...
  function(e, t, n) {
    ...
    void 0 !== r(t) && (t.netlifyIdentity = i.default),
      void 0 !== ("undefined" == typeof window ? "undefined" : r(window)) &&
        (window.netlifyIdentity = i.default),
  ...
  function(e, t, n) {
    ...
    function a(e) {
      ...
      if (t && n) {
        ...
        return (
          ...
          D.default.setIsLocal(t),
          D.default.setSiteURL(n),
          new y.default({ APIUrl: r.join(""), setCookie: !t })
        )
      }
      return t
        ? (D.default.setIsLocal(t), null)
        : new y.default({ setCookie: !t })
    }
    function s() {
      ...
      if (e) {
        ...
        e.match(k) &&
          (D.default.openModal("signup"), (document.location.hash = ""))
        if (e.match(A)) {
          var n = {}
          if (
            ...
            document &&
              n.access_token &&
              (document.cookie = "nf_jwt=" + n.access_token),
            n.state)
          )
            try {
    ...
    var c = (function() {
      ...
      w = {
        ...
        get gotrue() {
          return (
            D.default.gotrue || D.default.openModal("login"), D.default.gotrue
          )
        },
        init: function(e) {
          u(e)
                    ...
                    return (
                      e instanceof a.JSONHTTPError &&
                        ...
                        (e.json.msg
                          ...
                          : e.json.error &&
                            (e.message =
                              e.json.error + ": " + e.json.error_description)),
                      Promise.reject(e)
                    )
                  })
                )
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return (
                  ...
                  new c.default(this.api, e, this.audience)
                    .getUserData()
                    .then(function(e) {
          ...
          [
            ...
            },
            {
              ...
              value: function(e) {
                ...
                var t = void 0
                try {
                  ;(t = JSON.parse(i(e.access_token.split(".")[1]))),
            ...
            },
            {
              ...
              value: function() {
                return (
                  localStorage.getItem("gotrue.user") && this._saveSession(),
                  this
                )
              },
            },
            ...
            },
            {
              ...
              get: function() {
                var t = {}
                for (var n in this)
                  n in e.prototype || n in d || (t[n] = this[n])
                return t
              },
            },
          ],
                ...
                if (n)
                  try {
                    var r = JSON.parse(n),
                      ...
                      a = r.audience
                    if (!o || !i) return null
                    return new e(t || new c.default(o, {}), i, a)._saveUserData(
                      r,
                      !0
                    )
                  } catch (e) {
                    return (
                      console.error(
                        Error("Gotrue-js: Error recovering session: " + e)
                      ),
                      null
                    )
                  }
          ...
          (o.gotrue &&
            o.gotrue
              ...
              .catch(
                (0, r.action)(function() {
                  o.error = Error(
                    "Failed to load settings from " + o.gotrue.api.apiURL
                  )
                })
              ))
      })),
      (o.setIsLocal = (0, r.action)(function(e) {
        o.isLocal = e
      })),
          ...
          function t() {
            ...
            return (
              ...
              (i.handleButton = function(e) {
                e.preventDefault(),
                  i.props.store.openModal(i.props.store.user ? "user" : "login")
              }),
              (a = n),
              o(i, a)
            )
