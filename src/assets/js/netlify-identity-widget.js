        ...
        if (0 !== D)
          for (var z = 0; D > z; z++) {
            ...
            null != w
              ? (d++, (y[w] = b))
              : (v ||
                  (void 0 !== b.splitText ? !o || b.nodeValue.trim() : o)) &&
                (f[j++] = b)
          }
        if (0 !== T)
          for (var z = 0; T > z; z++) {
    ...
    function(e, t, n) {
      ...
      ;(function(e) {
        ...
        function Ke(e, t) {
          var n
          return (
            (n = void 0 !== t ? qe(e, t) : ae(e) || Yn(e) ? Xe(e) : qe(e)),
            n.name
          )
        }
        function et(e, t) {
        ...
        function _t(e) {
          return (
            xe("asReference is deprecated, use observable.ref instead"),
            Cn.ref(e)
          )
        }
        function Qt(e) {
        ...
        var wn = Ye("ComputedValue", vn),
          ...
          Un = {
            ...
            shallowArray: function(e, t) {
              return (
                arguments.length > 2 && fe("shallowArray"), new pn(e, De, t)
              )
            },
            map: function(e, t) {
          ...
          er = (function() {
            ...
            return (
              ...
              (e.prototype.reportExceptionInDerivation = function(e) {
                ...
                console.error(n || r, e),
                  c() &&
                    M({ type: "error", message: n, error: e, object: this }),
    ...
    function(e, t, n) {
      ...
      function s() {
        ...
        if (e) {
          var t = e.match(L)
          t &&
            (D.default.verifyToken(t[1], t[2]), (document.location.hash = ""))
          e.match(k) &&
                ...
                value: function(e) {
                  ...
                  return p[e]
                    ...
                    : (p[e] = this.api
                        ...
                        .catch(function(n) {
                          return (
                            delete p[e], t.clearSession(), Promise.reject(n)
                          )
                        }))
                },
              },
